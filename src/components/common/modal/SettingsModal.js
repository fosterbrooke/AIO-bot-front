        ...
        <div className={s.modal_container}>
            <div  className={`${s.modal} ${s[`modal_${theme}`]}`}>
                ...
                <div className={s.tab}>
                    ...
                    <p className={`${s.tab_item} ${activePage===1&&s.active_item} ${s.disabled}`} onClick={()=>changePage(1)}>Account</p>
                    <p className={`${s.tab_item} ${activePage===2&&s.active_item} ${s.disabled} `} onClick={()=>changePage(2)}>Password</p>
